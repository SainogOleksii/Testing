...
public class ExpandedChromeDriver extends ChromeDriver {

    public ExpandedChromeDriver() throws Exception {
        this(new ChromeOptions());
    }

    public ExpandedChromeDriver(ChromeOptions options) throws Exception {
        this(ChromeDriverService.createDefaultService(), options);
    }

    public ExpandedChromeDriver(ChromeDriverService service, ChromeOptions options) throws Exception {
